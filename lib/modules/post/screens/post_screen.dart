...
class MyCustomFormState extends State<MyCustomForm> {
  ...
  Future<void> _loadResource() async {
    ...
    //await Get.find<PropertyController>().initial();
  }
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              child: DropdownButtonFormField(
                                ...
                                items:
                                    controller.propertyMap.entries.map((entry) {
                                ...
                                onSaved: (value) {
                                  ...
                                  print(
                                      "Save DropDown Fied" + value.toString());
                                },
                              ),
                            ),
                            Visibility(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      DottedBorder(
                                        ...
                                        dashPattern: [5, 2],
                                        color:
                                            controller.photoController == false
                                                ? Colors.red
                                                : AppColors.primaryColor,
                                        child:
                                            controller.photo.length == 0 &&
                                                    controller
                                                                  ...
                                                                  child: index ==
                                                                      ...
                                                                      ? GestureDetector(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                const Image(
                                                                              image: AssetImage("assets/images/add_photo_alternate.png"),
                                                                            ),
                                                                          ),
                                                                        )
                                                                      : Stack(
                                                                          alignment:
                                                                              Alignment.center,
                                                                          children: [
                                                                            controller.imageUrlList.isNotEmpty && index <= controller.imageUrlList.length
                                                                                ? CachedNetworkImage(
                                                                                    imageUrl: controller.imageUrlList[index - 1],
                                                                                    fit: BoxFit.cover,
                                                                                  )
                                                                                : Image.file(
                                                                                    File(controller.photo[index - controller.imageUrlList.length - 1].path),
                                                                                    fit: BoxFit.cover,
                                                                                    height: 190.h,
                                                                                  ),
                                                                            Positioned(
                                      ...
                                      Visibility(
                                          visible: controller.photoController ==
                                              false,
                                          child: Text(
                                          ...
                                          child: Column(
                                            children: [
                                              DropDownButtonFormFieldCustom(
                                                  ...
                                                  items:
                                                      controller.certificateMap,
                                                  fieldValue:
                                                      controller.legalStatus,
                                                  onSave: (v) {
                                    ...
                                    onTap: () async {
                                      ...
                                      if (_formKey.currentState!.validate() &&
                                        ...
                                        if (controller.isEdit) {
                                          Get.snackbar(
                                            "Chỉnh sửa thất bại",
                                            "Vui lòng kiểm tra lại thông tin bài đăng!",
                                            colorText: Colors.white,
