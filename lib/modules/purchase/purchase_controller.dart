...
class PurchaseController extends GetxController {
  ...
  Future<Map<MembershipPackage, Discount?>> getMembershipPackageAndDiscount() async {
    final mps = await repository.getMembershipPackage();
    final discounts = await repository.getDiscount();
    final discountMap = Map<String, Discount?>.fromIterable(discounts, key: (d) => d.membershipPackageId);
    final res = mps.fold<Map<MembershipPackage, Discount?>>({}, (result, package) {
